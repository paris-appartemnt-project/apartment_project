...
#Fonction pour trouver tous les commerces de proximité à moins de 500m de la maison: combine keepraiduset radius 500.
...
#Fonction pour trouver tous les cinémas à moins de 500m de la maison: combine keepraiduset radius 500.

cinema_500 <- function(cine) {
  colnames(cine)[8] <- c("XY")
...
# Nombre de cinémas à moins de 500m de la place Saint-Michel 
...
#Fonction pour trouver tous les écoles à moins de 500m de la maison: combine keepraiduset radius 500.

school_500 <- function(schools){
  colnames(schools)[8] <- c("XY")
  coord_schools <- keepradius(schools)
  schools_prox <- radius500(coord_schools)
  colnames(schools_prox) <- (" schools @ 500m")
  return (schools_prox)
   
}

# Nombre d'écoles à moins de 500m de la place Saint-Michel 
...
#Fonction pour trouver toutes les stations de velib à moins de 500m de la maison: combine keepraidus et radius 500.

velib_500 <- function(velib){
  colnames(velib)[6] <- c("XY")
  coord_velib <- keepradius(velib)
  velib_prox <- radius500(coord_velib)
  colnames(velib_prox) <- (" velib @ 500m")
  return (velib_prox)
   
}

# Nombre de stations velib à moins de 500m de la place Saint-Michel 
...
#Fonction pour trouver toutes les stations de métro à moins de 500m de la maison: combine keepraidus et radius 500.
...
stations_500 <- function(stations){
  ...
  coord_stations <- keepradius(stations)
  stations_prox <- radius500(coord_stations)
  colnames(stations_prox) <- (" stations @ 500m")
  return (stations_prox)
   
}

# Nombre de stations métro à moins de 500m de la place Saint-Michel 

stations_500(stations)
