...
## Step 2 : Ad to the data previously created all the descriptions (that are on a different html page)
...
list_url_description2 <- list_url_description %>% 
  map(read_html)

# Extract the description from one particular ad 
...
castorus_description <- lapply(list_url_description2, get_description)
